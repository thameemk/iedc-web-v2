            ...
            <div class="col-12 col-md-6 grid-margin">
                <div class="card text-white bg-secondary">
                    <a href="<?= base_url() ?>user/dashboard/business-model">
                        ...
                        <div class="card-body">
                            <p class="card-text text-white">Submit your model for evaluation from our expert mentor
                                pool.</p>
                        </div>
                    </a>
                </div>
            ...
            <div class="col-12 col-md-6 grid-margin">
                <div class="card text-white bg-dark">
                    <a href="<?= base_url() ?>user/dashboard/schedule-meeting">
                        ...
                        <div class="card-body">
                            <p class="card-text text-white">Digitalise all your meetings with a personalised calendar.
                            </p>
                        </div>
                    </a>
                </div>
