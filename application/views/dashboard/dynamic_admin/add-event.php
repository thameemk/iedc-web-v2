                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <textarea name="event_desc" class="form-control" name="tinymce" id="simpleMdeExample" rows="10"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="radio-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_public" id="optionsRadios0" value="option5" />
                                        Yes
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_public" id="optionsRadios01" value="option5" />
                                        No
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="radio-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_iedc_member" id="optionsRadios1" value="option5" />
                                        Yes
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_iedc_member" id="optionsRadios2" value="option5" />
                                        No
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="radio-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_reg_open" id="optionsRadios3" value="option5" />
                                        Yes
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_reg_open" id="optionsRadios4" value="option5" />
                                        No
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="radio-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_file_submission" id="optionsRadios7" value="option5" />
                                        Yes
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_file_submission" id="optionsRadios8" value="option5" />
                                        No
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="radio-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_team" id="optionsRadios9" value="option5" />
                                        Yes
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_team" id="optionsRadios10" value="option5" />
                                        No
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="radio-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_payment_id" id="optionsRadios11" value="option5" />
                                        Yes
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="is_payment_id" id="optionsRadios12" value="option5" />
                                        No
                                    </label>
                                </div>
                            </div>
