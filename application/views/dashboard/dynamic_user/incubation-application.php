                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="parent_mobile_number"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="comm_address"
                                placeholder="Enter communication Address" required>
                        </div>
                        <div class="form-group">
                            <label>Permanent of Communication</label>
                            <input type="text" class="form-control" name="perm_address"
                                placeholder="Enter permenent Address" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="business_idea"
                            placeholder="Specifiy your area of business or idea" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="business_ownership"
                            onchange="businessOwnershipOther(this.value)" required>
                            <option value="">select an option</option>
                            <option value="proprietorship">Proprietorship</option>
                            <option value="partnership">Partnership</option>
                            <option value="other">Other</option>
                        </select>
                        <input class="mt-3 form-control" id="business_ownership" style='display:none;'
                            name="business_ownership_other" type="text" placeholder="Specify" />
                    ...
                    <div class="form-group">
                        <label for="description">Brief Description of the underlying Innovation and Technology(300
                            words) :</label>
                    ...
                    <div class="form-group" style="margin-left:10px ;">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input name="ser_oth" id="ser_others" value="yes" type="checkbox"
                                    onclick="serviceShowSpecifyOthers()" class="form-check-input">
                                Others
                        </div>
                        <input id="ser_others_text" type="text" class="form-control" placeholder="Specify"
                            name="ser_others_text" style="display: none;">
                    </div>

                    <div class="form-group">
                        <label for="bus_experience">Do you or your team members have any previous experience?</label>
                        <select onchange="businessExperienceYes(this.value)" required class="form-control"
                            name="bus_experience">
                        ...
                        <div id="bus_experience" class="form-group mt-3" style="padding-left: 20px; display:none">
                            ...
                            <label>2. How do you think your past experience is going to help you in this new
                                venture?(Maximum 150 words) :</label>
                    ...
                    <div class="form-group" style="margin-left:10px ;">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" name="business_plan_outline" value="yes"
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" name="maket_feasibility_study" value="yes"
                                    class="form-check-input">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" name="intellectual_property_strategy" value="yes"
                                    class="form-check-input">
                    ...
                    <div class="form-group">
                        <label for="businessTime">Do you need any machinery or capital item for starting your
                            venture?</label>
                        <select class="form-control" name="bus_machinary_capital" required
                            onchange="busMachinaryCapital(this.value)">
                            <option>select an option</option>
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                        <input type="text" class="form-control mt-3" placeholder="Specify" style="display: none;"
                            id="bus_machinary_capital" name="bus_machinary_capital_yes">
                    </div>
                    <div class="form-group">
                        <label for="businessTime">Have you estimated your project cost?</label>
                        <select class="form-control" name="bussiness_estimate" required
                            onchange="busEstimateYes(this.value)">
                            <option>select an option</option>
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                    ...
                    <div class="form-group">
                        <label>Have you estimated and identified your seed financing needs/source? (Furnish Details)
                            :</label>
                    ...
                    <div class="form-group">
                        ...
                        <div id="market_survey" class="mt-3" style="display: none;">
                            <div class="form-group" style="padding-left: 20px;">
                                <label for="marketSurvey">1. If yes,briefly describe the methods and results (Maximum
                                    200 words) :</label>
                                <textarea type="text" class="form-control"
                                    name="market_survey_methods_results"></textarea>
                            </div>
                            <div class="form-group" style="padding-left: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <div id="tech_own_other" class="mt-3" style="display: none;">
                            <div class="form-group" style="padding-left: 20px;">
                                <label for="source">1. If your own,have you completed technology development? Or what
                                    stage you are in the developmental process?What is the estimated time for completion
                                    of development of the technology?(100 Words)
                                    :</label>
                                <textarea type="text" class="form-control" name="tech_own_other_one"></textarea>
                            </div>
                            <div class="form-group" style="padding-left: 20px;">
                                <label for="source">2. Can your technology or product be patented,trademarked or
                                    protected from duplication(if applicable)?If not what other sustainable competitive
                                    advatnage do you have? :</label>
                                <textarea type="text" class="form-control" name="tech_own_other_two"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class=" form-group ">
                        <label for="space">Your reason(s) for seeking space in the incubator(Maximum 100 Words)
                            :</label>
                        <textarea type="text " class="form-control " name="bus_reason" required></textarea>
                    </div>
                    <div class=" form-group ">
                        <label for="space">How much money has already been invested in the company and by whom? Furnish
                            details. :</label>
                    ...
                    <div class=" form-group ">
                        ...
                        <select class="form-control mb-3" name="space" required name="bus_special_facility"
                            onchange="busSpecialFacility(this.value)">
                            <option>select an option</option>
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                        <textarea style="display: none;" id="bus_special_facility" type="text" class="mt-3 form-control"
                            name="bus_special_facility_yes"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="hazardous">Do you expect to use any hazardous or toxic materials?If so,describe. :
                        </label>
                        <select class="form-control mb-3" name="bus_hazardous" required
                            onchange="busHazardous(this.value)">
                            <option>select an option</option>
                            <option value="yes">Yes</option>
                            <option value="no">No</option>
                        </select>
                        <textarea style="display: none;" id="bus_hazardous" type="text" class="mt-3 form-control"
                            name="bus_hazardous_yes"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="assistance">Do you need technology development or assistance? (Tick areas of
                            assistance required from the incubator whichever apply) :</label>
                    </div>
                    <div class="form-group" style="margin-left:10px ;">
                        <div class="form-check">
                            <label class="form-check-label">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" name="ass_commercialization" value="yes"
                                    class="form-check-input">
                                Commercialization
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" id="ass_other" name="ass_other" value="yes"
                                    class="form-check-input" onclick="assistanceOther()">
                                Others,please specify:
                            </label>
                            <input type="text" id="ass_other_text" name="ass_other_text" style="display:none;"
