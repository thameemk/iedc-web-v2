    ...
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form class="forms-sample" method="post" action="<?=base_url("user/schedule_meeting_post")?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="time" class="form-control" name="time" id="time" autocomplete="off" placeholder="Time" required>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <textarea class="form-control" name="meeting_agenda" id="meeting_agenda" rows="5" required></textarea>
            </div>
            <div class="form-group row">
