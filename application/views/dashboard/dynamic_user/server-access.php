        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="<?= base_url("member/server_accsess_post") ?>">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Website Title</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="title" id="date"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="domain"
                                    placeholder="Your domain name.(if any)" rows="5">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <textarea type="text" class="form-control" name="purpose" autocomplete="off"
                                placeholder="Purpose of your website" required></textarea>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Technologies/Languages</label>
                            <textarea class="form-control" name="tech_or_lang" rows="5"
                                placeholder="Technologies or Languages usd to build your website" required></textarea>
                        </div>
