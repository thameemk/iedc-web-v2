...
<head>
	...
	<title>Login - Innovation and Entrepreneurship Development Cell, TKM College of Engineering</title>
				...
				<div class="text-middle">
					<div class="text-center m-b-30">
						<a href="<?=base_url()?>" class="logo">
							<img src="<?=base_url()?>/theme/images/logo.png" alt="IEDC Logo">
						</a>
					</div>
					<div class="row">
						<div class="center p-50 background-white b-r-6">
								<div class="text-left center form-group">
