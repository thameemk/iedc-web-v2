    ...
    <div class="container">
        ...
        <div class="row team-members m-b-40">
            <div class="col-lg-3">
                <div class="team-member">
                    <div class="team-image">
                        <img src="<?=base_url()?>assets/uploads/images/team/2019-2020/VIGNESH.jpg">
                    </div>
                    <div class="team-desc">
                        <h3>Vignesh</h3>
                        <p>Lorem ipsum</p>
            ...
            <div class="col-lg-3">
                <div class="team-member">
                    <div class="team-image">
                        <img src="<?=base_url()?>assets/uploads/images/team/2019-2020/THOMAS.jpg">
                    </div>
                    <div class="team-desc">
                        <h3>Thomas</h3>
                        <p>Lorem Ipsum</p>
            ...
            <div class="col-lg-3">
                <div class="team-member">
                    <div class="team-image">
                        <img src="<?=base_url()?>assets/uploads/images/team/2019-2020/AMOS.jpg">
                    </div>
                    <div class="team-desc">
                        <h3>Amos</h3>
                        <p>Lorem Ipsum</p>
