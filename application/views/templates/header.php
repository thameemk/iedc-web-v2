...
<head>
	...
	<link href="<?php echo base_url()?>assets/front/css/plugins.css" rel="stylesheet">
						...
						<ul>
							...
							<li class="d-none d-sm-block">
								...
								<div id="shopping-cart" class="p-dropdown">
									<a href="shop-cart.html"><span class="shopping-cart-items">8</span><i class="icon-shopping-cart1"></i></a>
								...
								<ul>
									...
									<li class="dropdown"> <a href="#">Layout</a>
										<ul class="dropdown-menu">
											...
											<li><a href="preview/index.html">Layout Demos<span class="badge badge-primary">200+</span></a></li>
										</ul>
									</li>
												...
												<div class="row">
													...
													<div class="col-lg-2">
														<ul>
															...
															<li> <a href="component-datatable.html"> <i class="fa fa-table"></i>Data Tables <span class="badge badge-danger">NEW</span></a></li>
															<li>
													...
													<div class="col-lg-2">
														<ul>
															...
															<li>
																<a href="shortcode-lists.html"> <i class="fa fa-th-list"></i>Lists & Bullet
																	lists</a>
															</li>
															<li>
													...
													<div class="col-lg-2">
														<ul>
															<li> <a href="shortcode-pricing-table.html"><i class="fas fa-dollar-sign"></i>Pricing
																	tables</a> </li>
															<li>
